...
const FAQ_ITEMS: { q: string; a: string }[] = [
  {
    q: 'מה זה הבחירה הצפונית בקריית שמונה?',
    a:
      'הבחירה הצפונית הוא פרויקט קהילתי שמעודד משפחות עם זיקה לישראל לשקול מעבר לצפון — ובפרט לקריית שמונה (גם בחיפושים כמו "הבחירה הצפונית קרית שמונה"). באתר k8now.com תמצאו מידע על דיור, קהילה, הטבות מס ותהליך היכרות עם העיר. השאירו פרטים בטופס ונחזור אליכם.',
  },
  {
  ...
  },
  {
    ...
    a:
      'באפשרותך למלא את טופס יצירת הקשר בדף הבית, או לכתוב לכתובת Info@north-il.center. נשמח לחזור אליכם ולתאם מפגש או סיור.',
  },
];
