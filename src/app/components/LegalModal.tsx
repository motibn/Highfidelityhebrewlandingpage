...
export const TERMS_CONTENT: LegalDocument = {
  ...
  sections: [
    ...
    },
    {
      heading: 'יצירת קשר',
      paragraphs: [
        'לשאלות בנוגע לתנאי השימוש ניתן לפנות ל-מרכזה צפון בכתובת שדרות תל חי 98, קרית שמונה או במייל info@ks-north.co.il.',
      ],
    },
  ],
};
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'לפניות בנושא פרטיות: info@ks-north.co.il או שדרות תל חי 98, קרית שמונה, בציון "בקשה בנושא פרטיות".',
      ],
    },
    {
      heading: 'שמירת מידע',
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'מרכזה צפון, שדרות תל חי 98, קרית שמונה. דוא"ל: info@ks-north.co.il.',
      ],
    },
  ],
};
