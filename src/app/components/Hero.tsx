  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        {/* Warm cream overlay over the image */}
        <div style={{
          position: 'absolute', inset: 0,
      ...
      >
        <div className="px-[0px] pt-[10px] pb-[0px] px-[0px] pt-[50px] pb-[0px] px-[0px] pt-[60px] pb-[0px]" style={{ maxWidth: '900px', width: '100%', textAlign: 'center' }}>

          {/* Partner logos — 150px above title, in flow */}
          <motion.div
      ...
      {/* Seal bottom gap — solid strip matching VideoStory background */}
      <div style={{
        position: 'absolute',
        bottom: 0,
        left: 0,
