...
export const HOME_SEO = {
  title: 'הבחירה הצפונית – קריית שמונה מחכה לכם | עוברים צפונה',
  description:
    'הבחירה הצפונית – פרויקט קהילתי לעלייה לקריית שמונה (קרית שמונה). מעל 200 משפחות, דירות מ-750,000 ₪, הטבות מס וקהילה. השאירו פרטים.',
  canonical: 'https://www.k8now.com/',
} as const;
