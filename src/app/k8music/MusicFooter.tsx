...
const PAGE_LINKS = [
  { label: 'דף הקהילה', href: '/k8music/' },
  { label: 'מה מחכה', href: '/k8music/#offer' },
  { label: 'שגרה', href: '/k8music/#rhythm' },
  { label: 'למה כאן', href: '/k8music/#why' },
  { label: 'איך מצטרפים', href: '/k8music/#process' },
  { label: 'שאלות', href: '/k8music/#faq' },
  { label: 'צרו קשר', href: '/k8music/#contact' },
  { label: 'דף הבית', href: '/' },
] as const;
    ...
    >
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 44 }}>
          ...
          >
            קריית שמונה · הסצנה הבאה של ישראל
          </p>
          <div
            style={{
              width: 60,
        ...
        >
          <div style={{ maxWidth: 280 }}>
            ...
            >
              אולפן, במה וקהילה בקריית שמונה — עם ליווי אישי למעבר, דיור ותעסוקה בחינוך ובתרבות.
            </p>
          </div>
