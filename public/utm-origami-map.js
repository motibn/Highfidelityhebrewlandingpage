/* AUTO-GENERATED from src/app/utils/utmOrigamiMap.ts — do not edit by hand */
(function (global) {
  var UTM_SOURCE_FALLBACK = 'אתר';
  var UTM_MEDIUM_FALLBACK = 'אחר';
  var UTM_SOURCE_EXACT = {
  // Google / Search
  google: 'google',
  googleads: 'google',
  google_ads: 'google',
